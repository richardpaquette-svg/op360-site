...
const OP360 = {
  ...
  offres: [
    ...
    { icone:`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00d4aa" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/></svg>`, titre:"Due Diligence Opérationnelle", href:"due-diligence.html", featured:false, badge:"", accroche:"Sécuriser un deal avant et après signature.", bullets:["Analyse opérationnelle des risques et leviers de valeur pré/post deal.","Recommandations concrètes pour traduire la thèse en plan d'action pilotable."] },
    { icone:`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00d4aa" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>`, titre:"Formations & Workshops", href:"formations.html", featured:false, badge:"", accroche:"Faire grandir vos équipes.", bullets:["Ateliers pratiques sur l'exécution, le leadership, le pilotage et l'innovation.","Modules sur-mesure pour renforcer l'autonomie et le passage à l'action."] },
