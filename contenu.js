...
const OP360 = {
  ...
  // ── 6 OFFRES ──────────────────────────────────────
  offres: [
    { icone:`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00d4aa" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></svg>`, titre:"Diagnostic OP360", href:"diagnostic.html", featured:true, badge:"Recommandé", bullets:["En 8 jours, voir clair sur votre capacité d'exécution.","Diagnostic 360° sur 12 domaines clés.","Plan d'action priorisé, prêt à être exécuté."] },
    { icone:`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00d4aa" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>`, titre:"Shadow Codir", href:"shadow-codir.html", featured:false, badge:"", bullets:["Un Shadow Codir de pairs pour éclairer vos décisions clés.","Regards croisés stratégiques, opérationnels et financiers.","Mobilisable ponctuellement ou dans la durée."] },
    { icone:`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00d4aa" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>`, titre:"Accompagnement Terrain", href:"accompagnement.html", featured:false, badge:"", bullets:["Des Operating Partners qui exécutent avec vous, sur le terrain.","Interventions en immersion ou en appui, à la bonne intensité.","Pilotage des chantiers jusqu'aux premiers résultats visibles."] },
    { icone:`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00d4aa" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/></svg>`, titre:"Due Diligence Opérationnelle", href:"due-diligence.html", featured:false, badge:"", bullets:["Un regard opérationnel pour sécuriser vos deals.","Analyse des risques et leviers de valeur pré/post investissement.","Intégration des enjeux RSE/ESG dans la lecture de la cible."] },
    { icone:`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00d4aa" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>`, titre:"Formations & Workshops", href:"formations.html", featured:false, badge:"", bullets:["Des formats orientés terrain pour faire grandir vos équipes.","Ateliers de résolution de problèmes et de pilotage de l'exécution.","Modules sur-mesure (leadership, finance, Lean, négociation, IA, etc.)."] },
    { icone:`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00d4aa" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/><polyline points="6 8 9 12 12 8 15 12 18 8"/></svg>`, titre:"Plateforme SaaS OP360", href:"saas.html", featured:false, badge:"", bullets:["Un cockpit digital pour piloter vos projets stratégiques.","Suivi structuré des chantiers, décisions et engagements.","Idea Vault et indicateurs pour réduire la charge mentale du dirigeant."] },
  ],
